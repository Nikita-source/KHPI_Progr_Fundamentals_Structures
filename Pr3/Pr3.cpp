...
Написати функцію, порахувати загальну кількість багажних місць і з'ясувати,
чи є пасажири з 1м багажним місцем вагою понад 30 кг.
*/
#include <iostream>
#include <Windows.h>
...
void printInformation(Info info[], int N)
{
	...
	if (kp != 0)
	{
		cout << "Пасажирів, у яких один чемодан більше 30 кг - " << kp << "\n";
	}
	else cout << "Пасажирів з одним чемоданом більше 30 кг немає" << "\n";
}
