...
Написати функцію і вивести список моделей, у яких максимальна швидкість більше 150 км / год
*/
...
// Функція заповнення масиву з інформацією про авто (створення масиву авто)
...
int main()
{
	...
	Car info[N];	// Оголошення масиву машин

	while (true)
	{
		inputInfo(info, N);	// Створення масиву машин

		cout << "Список моделей, у яких максимальна швидкість більше 150 км / год" << "\n";
